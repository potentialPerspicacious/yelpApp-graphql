...
import {res2cus} from '../../actions/messages'
            ...
            <div className="form">
                        ...
                        <label class="label-form"> Rate your recent dish</label>
                            ...
                            <Row >
                                ...
                                <Col s='3'>
                                <Button variant="outline-secondary" onClick = {this.cancelMessage}>Cancel</Button>
...
export default connect(mapStateToProps, { res2cus })(SendMessage);